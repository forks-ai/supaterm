...
- Sidebar tabs use fixed rest, hover, pressed, primary selection, secondary selection, outline, shadow, and title tokens; unrelated cards and dialogs keep their own surface roles.
